...
min_version="${MIN_VERSION:-3.0.0-stage9.23.20260803-kb001}"
...
[ -f "${package_root}/images/lianruan-crm-v3-api-${target_version}.docker-image" ] || fail "缺少 API 镜像。"
[ -f "${package_root}/images/lianruan-crm-v3-nginx-${target_version}.docker-image" ] || fail "缺少 Nginx 镜像。"
...
info "通过。当前版本：${current_version}，最低建议版本：${min_version}，目标版本：${target_version}"

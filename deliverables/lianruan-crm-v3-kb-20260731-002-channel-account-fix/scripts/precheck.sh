...
[ -f "${package_root}/images/lianruan-crm-v3-api-3.0.0-stage9.22.20260731-kb002.tar" ] || 失败 "缺少 API 镜像。"
[ -f "${package_root}/images/lianruan-crm-v3-nginx-3.0.0-stage9.22.20260731-kb002.tar" ] || 失败 "缺少 Nginx 镜像。"

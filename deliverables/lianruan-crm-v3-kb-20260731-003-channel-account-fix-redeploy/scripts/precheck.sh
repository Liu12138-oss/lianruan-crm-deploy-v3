...
[ -f "${package_root}/images/lianruan-crm-v3-api-${target_version}.tar" ] || 失败 "缺少 API 镜像。"
[ -f "${package_root}/images/lianruan-crm-v3-nginx-${target_version}.tar" ] || 失败 "缺少 Nginx 镜像。"

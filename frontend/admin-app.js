...
const AdminSingleSignOnPageV2 = {
  ...
  <div class="login-page">
    ...
    <div class="login-card">
      <div class="login-logo">
        ...
        <h1>Admin Single Sign-On</h1>
        <p>Validating IAM login token <span class="admin-badge">V2</span></p>
      </div>
      <p style="font-size:14px;text-align:center;color:#666;line-height:1.7">{{ message }}</p>
      <button v-if="showBack" class="btn btn-primary" style="width:100%;justify-content:center;padding:11px;font-size:15px;margin-top:18px" @click="goLogin">
        Back To Login
  ...
  setup() {
    ...
    async function doSingleSignOn() {
      ...
      try {
        const res = await apiRequest('POST', '/sso/iam/admin-login-v2', { token });
        if (!res.success || !res.user || !res.token) {
...
const Partners = {
              ...
              <div class="partner-create-profile-panels">
                ...
                <section class="partner-create-profile-panel full">
                  ...
                  <div class="partner-create-profile-form-grid form-grid-3">
                    ...
                    <div class="form-item"><label class="form-label">主要客户或行业</label><textarea class="form-control" v-model="form.customerIndustriesText" placeholder="教育、医疗、制造、园区"></textarea></div>
            ...
            <aside class="partner-profile-side">
              ...
              <div class="partner-profile-side-section">
                <dl>
	              ...
	              <div class="partner-profile-side-section">
	                <div class="partner-profile-side-title">主要客户或行业</div>
  ...
  setup() {
    ...
    const isPartnerCityValid = computed(() => {
      ...
      return !cityOptions.value.length || cityOptions.value.includes(form.city);
    });
    ...
    async function loadPartnerProfile(partnerId) {
      ...
      try {
        ...
        if (res.success && res.data) {
          ...
          if (res.data.permissions?.canManageProducts) {
    ...
    async function save() {
      ...
      if (cityOptions.value.length && !cityOptions.value.includes(form.city)) {
    ...
    async function loadOpportunities() {
      ...
      try {
        ...
        if (result.success && result.data) {
          ...
          store.opportunities = result.data.map(opp => ({
            ...opp,
            followUps: Array.isArray(opp.followUps) ? opp.followUps : [],
